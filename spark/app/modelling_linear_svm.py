...
train_test_model(training, test, "Linear SVM", directory=directory_path)
...
model, prediction, fscore = train_test_model(training, test, "Linear SVM", weights=True, directory=directory_path)
...
plt.savefig(f"{directory_path}/chart11_LinearSVM_ConfMatrix.png")
